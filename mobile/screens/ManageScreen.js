...
export default function ManageScreen() {
  ...
  const handleMapTap = (e) => {
    ...
    if (pickerTarget === 'mp') { setMpLat(lat); setMpLng(lng); }
    else if (pickerTarget === 'poi') { setPoiLat(lat); setPoiLng(lng); }
    ...
    <ScrollView style={styles.container} contentContainerStyle={styles.content}>
      ...
      {pickerTarget && (
        <View style={[styles.card, SHADOWS.small]}>
          <Text style={styles.cardTitle}>
            Tap the map to set {pickerTarget === 'mp' ? 'meeting point' : 'POI'} location
          </Text>
          <MapView
            ref={miniMapRef}
      ...
      <View style={[styles.card, SHADOWS.small]}>
        ...
        <View style={styles.row}>
          ...
          <Pressable style={styles.mapPickBtn} onPress={() => setPickerTarget('mp')}>
      ...
      <View style={[styles.card, SHADOWS.small]}>
        ...
        <View style={styles.row}>
          ...
          <Pressable style={styles.mapPickBtn} onPress={() => setPickerTarget('poi')}>
